    ...
    <div class="d-flex">
        <aside id="sidebar">
            <div class="sidebar-logo">
                <a href="{{ url('/home')}}"><img src="{{asset('images/logo.png')}}" style="height: 40px;">Atma Laundry</a>
            </div>
            <ul class="sidebar-nav p-0">
                <li class="sidebar-item">
                    <a href="{{ url('user/dashUser')}}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="{{ url('user/profileUser')}}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="{{ url('user/jasaUser')}}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="{{ url('user/barangUser')}}" class="sidebar-link">
